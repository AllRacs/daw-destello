...
function filtrado(){
  ...
  } else if(strlen($_POST['input_pass']) < 6 && strlen($_POST['input_pass']) > 15){ // entre 6 y 15 solo caracteres ingleses, numeros y subrayado. Min una letra mayuscula, una minuscula y un numero

    $result = false;
    echo 'Tu contraseña debería tener entre 6 y 15 carácteres';

  }else if(strcmp($_POST['input_pass'], $_POST['input_pass_confirm'])!=0) { //Comprobar que las contraseñas coinciden
